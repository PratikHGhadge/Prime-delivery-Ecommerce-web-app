            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <div className="mt-6">
                ...
                <div className="flex items-center">
                  ...
                  <a
                    href={reviews.href}
                    className="ml-3 text-sm font-medium text-custom-blue hover:text-custom-darkblue1"
                  >
              ...
              <form className="mt-10">
                ...
                <div className="mt-10">
                  <div className="flex items-center justify-between">
                    ...
                    <a
                      href="#"
                      className="text-sm font-medium text-custom-blue hover:text-custom-darkblue1"
                    >
                      Size guide
                    </a>
                  </div>
                        ...
                        <RadioGroup.Option
                          ...
                          className={({ active }) =>
                            classNames(
                              ...
                              active ? "ring-2 ring-custom-blue" : "",
